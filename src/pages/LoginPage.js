...
export default function LoginPage() {
  ...
  const bgStyle = {
    ...
    background: "linear-gradient(135deg, " + COLORS.green + " 0%, " + COLORS.greenD + " 100%)"
  };
    ...
    <div style={bgStyle}>
      <form onSubmit={handleLogin} style={formStyle}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <p style={{ color: COLORS.orange, fontSize: 13, fontWeight: 700, margin: "6px 0 0", textTransform: "uppercase", letterSpacing: 3 }}>Espace protege</p>
        </div>
        <div style={{ marginBottom: 14 }}>
          <label style={{ fontSize: 12, fontWeight: 600, color: COLORS.sub }}>Email</label>
          <input value={email} onChange={function(e) { setEmail(e.target.value); }} type="email" placeholder="votre@email.fr" required style={inputStyle} />
        </div>
        <div style={{ marginBottom: 24 }}>
          <label style={{ fontSize: 12, fontWeight: 600, color: COLORS.sub }}>Mot de passe</label>
          <input value={password} onChange={function(e) { setPassword(e.target.value); }} type="password" placeholder="********" required style={inputStyle} />
        </div>
        ...
        <p style={{ textAlign: "center", marginTop: 20, fontSize: 12, color: COLORS.sub }}>
